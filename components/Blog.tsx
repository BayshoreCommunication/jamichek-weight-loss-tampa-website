    ...
    <section className="max-w-[1640px] mx-auto px-8 md:my-16 my-8">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-transform transform hover:-translate-y-2 duration-300"
          >
            {/* Image */}
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              <a href={blog.link} className="text-primary font-medium">
                Read More
              </a>
            </div>
          </div>
