    ...
    const cards = [
        {
            id: "01",
            title: "Our Purpose",
            text: "At Jachimiek Wellness Center, we believe that the body has the ability to heal itself. Our goal is to remove any interference in the nervous system and allow the body to function at its best.",
            icon: (
                <Image
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-8 items-start">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {cards.map((card) => (
                        ...
                        >
                            <span className="text-gray-400 font-semibold mb-4">/{card.id}</span>
                ...
                <div>
                    <h2 className="text-3xl font-bold text-gray-900 leading-snug mb-4">
                        Why Choose Our <span className="text-primary">Weight Loss</span> Program
                    </h2>
