      ...
      <div className="mt-12 space-y-12">
        ...
        <section className="border-t-2 border-[#2E75B6] pt-5">
          ...
          <div className="mt-4 space-y-5 text-[17px] leading-8">
            ...
            <h3 className="text-[#1B4F8A] text-[#1B4F8A] mt-8 text-center text-[#1B4F8A] text-lg sm:text-xl font-bold">
              ...
              <table className="w-full text-left border-collapse min-w-[550px]">
                <thead>
                  <tr className="bg-[#1F4E79] text-sm sm:text-base font-bold text-white">
                    <th className="border-r border-white/30 px-3 sm:px-4 py-3">Factor</th>
                    <th className="border-r border-white/30 px-3 sm:px-4 py-3">How It Affects Speed</th>
                    <th className="px-3 sm:px-4 py-3">What Helps</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <section className="border-t-2 border-[#2E75B6] pt-5">
          ...
          <div className="mt-4 space-y-5 text-[17px] leading-8">
            ...
            <div className="mt-8 border border-[#D6E4F0] bg-[#F2F8FD] rounded-xl overflow-hidden">
              <div className="bg-[#1F4E79] px-4 sm:px-5 py-3 text-sm sm:text-base font-bold uppercase tracking-[0.16em] text-white">
              ...
              <ul className="space-y-3 px-4 sm:px-6 py-6 text-[17px] leading-8">
                {selfChecks.map((check, i) => (
                  <li key={i} className="flex gap-3">
                    ...
                    <span className="text-left sm:text-justify">{check}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section className="border-t-2 border-[#2E75B6] pt-5">
          ...
          <div className="mt-4 space-y-5 text-[17px] leading-8">
            ...
            <div className="mt-8 border-l-[8px] border-[#D9534F] bg-[#FDF2F2] px-4 sm:px-6 py-5 rounded-r-lg">
              ...
              <p className="text-[17px] leading-8 text-[#D9534F] text-left sm:text-justify">
            ...
            <p className="text-left sm:text-justify mt-5">
        ...
        <section className="border-t-2 border-[#2E75B6] pt-5">
          ...
          <div className="mt-4 space-y-5 text-[17px] leading-8">
            ...
            <div className="mt-8 border border-[#D6E4F0] overflow-hidden rounded-xl bg-white">
              ...
              <div className="divide-y divide-[#D6E4F0]">
                {journeySteps.map((step, index) => (
                  <div
                    key={index}
                    className={`px-4 sm:px-6 py-4 flex gap-3 sm:gap-4 items-center ${
                      index % 2 === 0 ? "bg-[#F2F8FD]" : "bg-white"
                    }`}
                  >
                    <span className="flex h-7 w-24 sm:w-28 shrink-0 items-center justify-center rounded-lg bg-[#1B4F8A] text-xs font-bold text-white px-2 py-1">
                      {step.time}
                    </span>
            ...
            <div className="mt-8 border-l-[8px] border-[#2E75B6] bg-[#F2F8FD] px-4 sm:px-6 py-5 rounded-r-lg">
